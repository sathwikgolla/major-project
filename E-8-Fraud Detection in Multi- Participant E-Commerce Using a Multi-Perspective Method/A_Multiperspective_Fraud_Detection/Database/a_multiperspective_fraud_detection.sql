...
--
-- Database: `a_multiperspective_fraud_detection`
--
CREATE DATABASE IF NOT EXISTS `a_multiperspective_fraud_detection` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `a_multiperspective_fraud_detection`;
...
('2nu8fdcldm8lytpfu4w96l2abjx43u6v', 'eyJ1c2VyaWQiOjEyfQ:1qTiZe:-k6ha5lJ1_nHcNkVetfGogHBGIwVRzbjiRdtEBl26BQ', '2023-08-23 12:46:02.868498'),
...
('kncavpi7muvutwpj987a5pvz8cyk2quq', 'eyJ1c2VyaWQiOjEzfQ:1qTjEg:GdPKL33--IbHW6DE1GORddUdd55x1IrqiRPB4wcPQGk', '2023-08-23 13:28:26.600562'),
...
(13, 'Gopinath', 'Gopinath123@gmail.com', 'Gopinath', '9535866270', 'India', 'Karnataka', 'bangalore', '#8928,4th Cross,Malleshwaram', 'Male');
...
(98, 'Naive Bayes', '53.63984674329502'),
(99, 'SVM', '51.91570881226054'),
(100, 'Logistic Regression', '52.10727969348659'),
(101, 'Decision Tree Classifier', '53.25670498084292'),
(102, 'Extra Tree Classifier', '51.724137931034484');
...
(34, 'Fraud Found in ECommerce Transaction', '66.66666666666666'),
(35, 'No Fraud Found in ECommerce Transaction', '33.33333333333333');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_fraud_detection`
--

CREATE TABLE IF NOT EXISTS `remote_user_fraud_detection` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Order_ID` varchar(3000) NOT NULL,
  `PDate` varchar(3000) NOT NULL,
  `Status` varchar(3000) NOT NULL,
  `Fulfilment` varchar(3000) NOT NULL,
  `Sales_Channel` varchar(3000) NOT NULL,
  `ship_service_level` varchar(3000) NOT NULL,
  `Style` varchar(3000) NOT NULL,
  `SKU` varchar(3000) NOT NULL,
  `Category` varchar(3000) NOT NULL,
  `PSize` varchar(3000) NOT NULL,
  `ASIN` varchar(3000) NOT NULL,
  `Qty` varchar(3000) NOT NULL,
  `currency` varchar(3000) NOT NULL,
  `Amount` varchar(3000) NOT NULL,
  `payment_by` varchar(3000) NOT NULL,
  `ship_city` varchar(3000) NOT NULL,
  `ship_state` varchar(3000) NOT NULL,
  `ship_postal_code` varchar(3000) NOT NULL,
  `ship_country` varchar(3000) NOT NULL,
  `Prediction` varchar(3000) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=13 ;

--
-- Dumping data for table `remote_user_fraud_detection`
--

INSERT INTO `remote_user_fraud_detection` (`id`, `Order_ID`, `PDate`, `Status`, `Fulfilment`, `Sales_Channel`, `ship_service_level`, `Style`, `SKU`, `Category`, `PSize`, `ASIN`, `Qty`, `currency`, `Amount`, `payment_by`, `ship_city`, `ship_state`, `ship_postal_code`, `ship_country`, `Prediction`) VALUES
(10, '203.205.158.62-10.42.0.151-80-37705-6', '04-30-22', 'Shipped', 'Amazon', 'Amazon.in', 'Expedited', 'JNE3405', 'JNE3405-KR-XL', 'kurta', 'XL', 'B081WT6GG7', '1', 'INR', '399', 'Debit card', 'NEW DELHI', 'DELHI', '110074', 'IN', 'No Fraud Found in ECommerce Transaction'),
(11, '10.42.0.151-76.13.28.196-53343-443-6', '04-30-22', 'Shipped - Delivered to Buyer', 'Merchant', 'Amazon.in', 'Standard', 'J0011', 'J0011-LCD-M', 'Set', 'M', 'B08B3YNJG5', '1', 'INR', '1233', 'Debit card', 'VISAKHAPATNAM', 'ANDHRA PRADESH', '530016', 'IN', 'Fraud Found in ECommerce Transaction'),
(12, '216.58.219.196-10.42.0.42-443-45549-6', '04-30-22', 'Shipped', 'Amazon', 'Amazon.in', 'Expedited', 'JNE3710', 'JNE3710-DR-S', 'Western Dress', 'S', 'B091SV9XW1', '1', 'INR', '690', 'Credit Card', 'GUWAHATI', 'ASSAM', '781026', 'IN', 'Fraud Found in ECommerce Transaction');
